      ...
      <div className="my-[80px] text-left mx-[100px]">
        ...
        <form method="post" onSubmit={onHandleSubmit} className="flex justify-between bg-dark_green/80 rounded-2xl border-2 border-green px-[40px]">
          ...
          <div>
            ...
            <Select id="powiat" name="powiats" values={["Wrocław", "Lublin", "Warszawa"]} placeholder="Powiat" styles="w-[340px] h-[50px] bg-yellow text-green border-2 border-green rounded-[20px] shadow-md mb-[30px] px-[20px] py-[10px] outline-0" forPage="" value={county} onChange={(e)=>{setCounty(e.target.value)}}/>
            <Select id="gmina" name="gminas" values={["Wrocław", "Lublin", "Warszawa"]} placeholder="Gmina" styles="w-[340px] h-[50px] bg-yellow text-green border-2 border-green rounded-[20px] shadow-md mb-[30px] px-[20px] py-[10px] outline-0" forPage="" value={community} onChange={(e)=>{setCommunity(e.target.value)}}/>
