  ...
  return (
    <form method="PUT" onSubmit={onHandleSubmit}>
      <div className="flex flex-col items-center w-[950px] h-[100%] bg-dark_green border-2 border-green rounded-[25px] py-[40px] px-[50px]">
        ...
        <Input id="old-pass" type="password" name="old-pass" value={oldPassword} placeholder="Stare hasło" width="w-[340px]" onChange={(e)=>{setOldPassword(e.target.value)}} required={true}/>
        <Input id="new-pass" type="password" name="new-pass" value={newPassword} placeholder="Nowe hasło" width="w-[340px]" onChange={(e)=>{setNewPassword(e.target.value)}} required={true}/>
