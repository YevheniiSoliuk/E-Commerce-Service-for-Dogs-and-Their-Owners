...
export const deliveryMethodCol = createCollection<IDeliveryMethod>("deliveryMethod");
...
export const paymentMethodCol = createCollection<IPaymentMethod>("paymentMethod");
