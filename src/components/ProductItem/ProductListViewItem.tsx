...
const ProductListViewItem = ({product, brands, action}: ProductCardProps) => {
  ...
  const {id, title, brand_id, long_description, photos, price, discount_price, base_price, discount_amount, rate} = {...product};
  ...
  return (
    <div className="flex justify-start w-full h-[100%] bg-yellow border-2 border-green shadow-lg px-[10px] py-[10px] text-left rounded-[25px] mb-[20px] tracking-[.1em] relative">
      ...
      {discount_amount !== null && discount_amount !== 0 ? <>
        ...
        <span className="absolute text-white text-[18px] -rotate-45 left-[0.5%] top-[3%]">{discount_amount}%</span>
      </> : null
      }
