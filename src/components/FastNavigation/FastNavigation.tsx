    ...
    <section className="flex items-end text-left mb-[30px]">
      <Link to="/">
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-[30px] h-[30px] fill-green hover:fill-yellow"
        >
        ...
        return (
          <span className="flex items-center" key={link.name}>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="inline-block w-[20px] h-[20px] fill-green mx-[10px]"
            >
              <path
                fillRule="evenodd"
            ...
            <Link to={link.link}>
              <p className="inline-block text-[14px] text-left hover:text-yellow">
                {link.name}
              </p>
            </Link>
          </span>
