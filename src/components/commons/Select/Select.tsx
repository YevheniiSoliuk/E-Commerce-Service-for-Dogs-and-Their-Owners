...
const Select = ({id, name, value, onChange, values, placeholder, icon, styles}: SelectProps) => {
  return (
    <div>
      {icon === true ?
        <div className="relative">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-[40px] h-[40px] absolute top-[5px] left-[10px]">
