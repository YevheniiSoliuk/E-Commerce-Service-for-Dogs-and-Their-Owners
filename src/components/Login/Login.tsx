...
const LoginPopup = () => {
  ...
  const goToNewPassModal = () => { closeForgotPassModal(); setIsNewPassModalOpen(open => !open) }
  ...
  return (
    <>
      ...
      <ForgotPassModal isOpen={isForgotPassOpen} close={closeForgotPassModal} comebackToPrevModal={goToLoginModal} goToOtherModal={goToNewPassModal}/>
      <SetNewPassModal isOpen={isNewPassModalOpen} close={closeNewPassModal} goToOtherModal={goToLoginModal} />
    </>
  )
}
