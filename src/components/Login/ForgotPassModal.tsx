...
export const ForgotPassModal: React.FC<ModalProps> = ({isOpen, close, goToOtherModal, comebackToPrevModal}) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >&times;</span>
        <h2 
          className="w-[440px] text-green text-[40px] font-semibold mt-[10px] leading-[45px]"
        >Przypomnienie hasła</h2>
        <p 
          className="w-[420px] my-[30px] text-[14px]"
        >Na Twój adres zostanie wysłany e-mail, który zawiera token do zmiany hasła. Zmiana hasła będzie możliwa po wypełnieniu wszystkich danych w formularzu.</p>
        <form 
          method="post" 
