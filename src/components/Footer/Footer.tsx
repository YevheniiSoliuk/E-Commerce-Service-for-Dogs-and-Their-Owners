...
export const Footer = () => {
  return (
    ...
    >
      <FastLinks 
        title="Zakupy" 
        fast_links={shoppingLinks}
      />
      <FastLinks 
        title="Nasze wsparcie" 
        fast_links={supportLinks}
      />
      <section className="text-left">
        ...
        />
        <span 
          className="text-[16px] hover:text-orange hover:underline hover:decoration-1 cursor-pointer"
        >Sprawdź na mapie</span>
      </section>
    </footer>
  )
}