...
export const CartPopup: React.FC<ModalProps> = ({isOpen, close}) => {
  ...
  const contentStyle = positionsAmount === 0 ? 
  ...
  return (
    ...
    >
      {positionsAmount === 0 ? 
        ...
        <div 
          className="w-[500px] h-[460px] bg-dark_green rounded-tl-[20px] rounded-bl-[20px] border-2 border-green text-base font-lemon text-green px-[15px] py-[25px] relative overflow-y-scroll"
        >
          <section>
